...
import com.appli.folist.storeAnimations.AnimationEndListener;
import com.appli.folist.storeAnimations.FoldAnimation;
import com.appli.folist.storeAnimations.HeightAnimation;
import com.appli.folist.storeview.FoldingCellView;
...
public class FoldingCell extends RelativeLayout {
    ...
    protected ArrayList<Integer> calculateHeightsForAnimationParts(int titleViewHeight, int contentViewHeight, int additionalFlipsCount) {
        ...
        if (additionalFlipsCount != 0) {
            ...
            System.out.println(additionalPartHeight + remainingHeight);
            System.out.println(titleViewHeight);
