...
public class Item {
    ...
    public static ArrayList<Item> getTestingList() {
        ...
        items.add(new Item("14円", "270円", "日本", "陰キャ", 3, "今日", "05:10 PM"));
        items.add(new Item("23円", "116円", "", "", 10, "今日", "11:10 AM"));
        items.add(new Item("63円", "350円", "", "", 0, "昨日", "07:11 PM"));
        items.add(new Item("19円", "150円", "2", "", 8, "昨日", "4:15 AM"));
        items.add(new Item("5円", "300円", "", "", 0, "一昨日", "06:15 PM"));
        return items;
    }
